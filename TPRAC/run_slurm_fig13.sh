...
echo "[INFO] Starting ChampSim simulations for Figure 13"
python3 "$PWD/sim_scripts/execute_run_script.py" -rc "run_config_fig13" --slurm

echo "[INFO] Fired all simulations for Figure 13: This can take ~2 days (For 602.gcc)"
rm "$PWD/run.sh" 