...
echo "[INFO] Starting ChampSim simulations for Figure 10"
python3 "$PWD/sim_scripts/execute_run_script.py" -rc "run_config_fig10" --slurm

# TODO: Show how long it takes for simulations
echo "[INFO] Fired all simulations for Figure 10: This can take ~20 hours"
rm "$PWD/run.sh" 