...
python3 setup_slurm.py \
    --ramulator_directory "/scratch/st-prashnr-1/jeonghyun/ramulator2/build" \
    ...
    --result_directory "/scratch/st-prashnr-1/jeonghyun/ramulator2/prac_study/QPRAC/4cores/500MInsts/MOP" \
