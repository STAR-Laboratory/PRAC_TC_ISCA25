...
CONFIG_PATH="./results/configs/AES_no_defense"

echo "Running Figure 5"

echo "Generating configuration files ..."
python3 ./scripts/util_scripts/gen_aes_yaml.py ./results/configs/example_AES_no_defense.yaml ./results/configs/AES_no_defense/
